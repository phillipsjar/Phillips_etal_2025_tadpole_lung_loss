violin_comparison = function(data1, data2, data3, name){
  ...
  vioplot(data1[,8:15], lineCol = "transparent", rectCol = "transparent",  xaxt = "n", 
          colMed = "transparent", col = colorBlindGrey8, main = paste(name,"1"),
          ylab = "Rate value")
  vioplot(data2[,8:15], lineCol = "transparent", rectCol = "transparent",  xaxt = "n", 
          colMed = "transparent", col = colorBlindGrey8, main = paste(name,"2"),
          ylab = "Rate value")
  par(mar = (c(4.1,4.1,1.1,2.1)))
  vioplot(data3[,8:15], lineCol = "transparent", rectCol = "transparent",  xaxt = "n", 
          colMed = "transparent", col = colorBlindGrey8, main = paste(name,"3"),
          ylab = "Rate value")
  legend(0,((par("usr")[3]) - (par("usr")[3])*.025), legend = labels, ncol = 4, fill = colorBlindGrey8, bty = "n", cex = 1)
}
